import RefusalFilter from "../components/RefusalFilter";


class RefusalListForm {

    constructor(form, Vue, popups) {
        this.form = form;
        this.$Vue = Vue;
        this.dataGrid = this.form.getComponentByName("RefusalListDataGrid").component;
        this.header = this.form.getComponentByName("RefusalListHeader").component;
        this.isMineToggle = this.form.getComponentByName("isMine").component;
        this.filter = new RefusalFilter(popups.refusalFilterPopup, Vue);
        ...
        Vue.$bus.$on("refusalIsMineChange", (e) => this.isMineChange(e));
    }
...
export default RefusalListForm;
